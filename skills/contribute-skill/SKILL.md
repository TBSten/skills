...
3. `skills/<skill-name>/README.md` — 詳細ドキュメント (英語)
4. `skills/<skill-name>/README.ja.md` — 詳細ドキュメント (日本語)
...
1. **必要なファイルが揃っているか** — 以下のファイルが存在することを確認する:
   - `./skills/<skill-name>/README.ja.md` が存在すること
   - `./skills/<skill-name>/README.md` が存在すること
...
2. `skills/<skill-name>/README.md` / `README.ja.md` に概要・使い方・前提条件を記述
