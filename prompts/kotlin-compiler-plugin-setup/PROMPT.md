...
以降に登場する `example/...` と `references/...` は、すべてリポジトリ内の `skills/kotlin-compiler-plugin-setup/` 配下のパスを指す。example ファイルは複数参照するので、最初に sparse clone して `/tmp/tbsten-skills/skills/kotlin-compiler-plugin-setup/` 配下をローカル参照するのを推奨する。
...
`settings.gradle.kts` を作成する。[`example/settings.gradle.kts`](https://raw.githubusercontent.com/TBSten/skills/refs/heads/main/skills/kotlin-compiler-plugin-setup/example/settings.gradle.kts) を参考にプロジェクト名とモジュール構成を設定。
...
`gradle/libs.versions.toml` を作成する。[`example/libs.versions.toml`](https://raw.githubusercontent.com/TBSten/skills/refs/heads/main/skills/kotlin-compiler-plugin-setup/example/libs.versions.toml) をベースに、以下の依存を含める:
...
`example/buildSrc/` 内のファイル (sparse clone 後の `/tmp/tbsten-skills/skills/kotlin-compiler-plugin-setup/example/buildSrc/`、または `https://api.github.com/repos/TBSten/skills/contents/skills/kotlin-compiler-plugin-setup/example/buildSrc` で一覧取得) をコピーし、プロジェクト固有の値を置換する。
...
[`example/compiler-plugin/build.gradle.kts`](https://raw.githubusercontent.com/TBSten/skills/refs/heads/main/skills/kotlin-compiler-plugin-setup/example/compiler-plugin/build.gradle.kts) をベースに作成する。
...
[`references/plugin-registration.md`](https://raw.githubusercontent.com/TBSten/skills/refs/heads/main/skills/kotlin-compiler-plugin-setup/references/plugin-registration.md) を参照して以下を作成:
...
[`example/runtime/build.gradle.kts`](https://raw.githubusercontent.com/TBSten/skills/refs/heads/main/skills/kotlin-compiler-plugin-setup/example/runtime/build.gradle.kts) をベースに作成。compiler plugin が提供する API の宣言をここに配置する。
...
[`example/gradle-plugin/build.gradle.kts`](https://raw.githubusercontent.com/TBSten/skills/refs/heads/main/skills/kotlin-compiler-plugin-setup/example/gradle-plugin/build.gradle.kts) をベースに作成。
...
[`references/gradle-plugin-impl.md`](https://raw.githubusercontent.com/TBSten/skills/refs/heads/main/skills/kotlin-compiler-plugin-setup/references/gradle-plugin-impl.md) に Gradle plugin の実装パターンを記載。

### Step 7: Unit Test のセットアップ

`compiler-plugin/src/test/` に kctfork (KotlinCompilation) を使ったテストを作成する。

[`references/testing-patterns.md`](https://raw.githubusercontent.com/TBSten/skills/refs/heads/main/skills/kotlin-compiler-plugin-setup/references/testing-patterns.md) を参照して以下のヘルパーを用意:
...
[`example/integration-test/test-jvm/build.gradle.kts`](https://raw.githubusercontent.com/TBSten/skills/refs/heads/main/skills/kotlin-compiler-plugin-setup/example/integration-test/test-jvm/build.gradle.kts) をベースに作成。
...
[`example/integration-test/test-kmp/build.gradle.kts`](https://raw.githubusercontent.com/TBSten/skills/refs/heads/main/skills/kotlin-compiler-plugin-setup/example/integration-test/test-kmp/build.gradle.kts) をベースに作成。
